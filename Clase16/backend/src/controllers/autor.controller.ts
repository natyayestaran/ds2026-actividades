...
export const getById = async (req: Request, res: Response) => {
  try {
    ...
    res.status(500).json({ error: "Error interno del servidor al buscar el autor" });
  }
};
...
export const create = async (req: Request, res: Response) => {
  try {
    ...
    res.status(500).json({ error: "Error interno del servidor al crear el autor" });
  }
};
...
export const remove = async (req: Request, res: Response) => {
  try {
    ...
    res.status(500).json({ error: "Error interno del servidor al eliminar el autor" });
  }
};
